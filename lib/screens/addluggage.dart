...
class AddLuggageAndItemsPage extends StatefulWidget {

  @override
  State<AddLuggageAndItemsPage> createState() => _AddLuggageAndItemsPageState();
}

class _AddLuggageAndItemsPageState extends State<AddLuggageAndItemsPage> {
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          flex: 2,
                                          child: TextFormField(
                                            key: ValueKey("${index}_${count}_${luggages[index]['items'][count]['item_name']}"),
                                        ...
                                        Expanded(
                                          child: TextFormField(
                                            ...
                                            key: ValueKey("${index}_${count}_${luggages[index]['items'][count]['quantity']}"),
